...
const TOOLS = [
    ...
    { id: 'delete_path', label: 'Delete File/Folder' },
    ...
    { id: 'openclaw_check_status', label: 'External Automation Status' },
    { id: 'openclaw_execute_action', label: 'External Automation Action' },
    { id: 'openclaw_send_message', label: 'Send Message' },
    { id: 'openclaw_read_conversation', label: 'Read Conversation' },
    { id: 'openclaw_search_email', label: 'Search Email' },
    { id: 'openclaw_draft_email', label: 'Draft Email' },
    { id: 'openclaw_send_email', label: 'Send Email' },
    { id: 'openclaw_list_calendar_events', label: 'List Calendar Events' },
    { id: 'openclaw_calendar_action', label: 'Calendar Action' },
    { id: 'openclaw_prepare_social_post', label: 'Prepare Social Post' },
    { id: 'openclaw_schedule_social_post', label: 'Schedule Social Post' },
    { id: 'openclaw_publish_social_post', label: 'Publish Social Post' },
    { id: 'openclaw_run_workflow', label: 'Run Workflow' },
    { id: 'get_pending_actions', label: 'List Pending Actions' },
    { id: 'confirm_pending_action', label: 'Confirm Pending Action' },
    { id: 'cancel_pending_action', label: 'Cancel Pending Action' },
    { id: 'create_openclaw_autopilot_rule', label: 'Create Auto Reply Rule' },
    { id: 'list_openclaw_autopilot_rules', label: 'List Auto Reply Rules' },
    { id: 'enable_openclaw_autopilot_rule', label: 'Enable Auto Reply Rule' },
    { id: 'disable_openclaw_autopilot_rule', label: 'Disable Auto Reply Rule' },
    { id: 'delete_openclaw_autopilot_rule', label: 'Delete Auto Reply Rule' },
];
